...
public class AdminController {
    private final UserAdminService users;private final GeologicalDocumentMapper documents;private final SystemLogService logs;private final LlmConfigService configs;public AdminController(UserAdminService users,GeologicalDocumentMapper documents,SystemLogService logs,LlmConfigService configs){this.users=users;this.documents=documents;this.logs=logs;this.configs=configs;}
