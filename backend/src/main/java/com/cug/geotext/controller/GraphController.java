...
public class GraphController {
    ...
    @GetMapping("/api/graph/nodes") public ApiResponse<AiGraphView>nodes(@RequestParam(required=false)String query,@RequestParam(required=false)Integer limit){return ApiResponse.ok(queryService.nodes(query,limit));}
